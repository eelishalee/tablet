...
const INITIAL_CREW = [
  ...
  { id: 'S26-003', name: '박기관', age: 55, role: '기관장', dept: '기관부', blood: 'B+', chronic: '고혈압, 고지혈증', allergies: '아스피린', contact: '010-2600-0003', emergency: '010-3344-5566 (배우자)', avatar: '/photo.jpeg', isEmergency: true, height: 172, weight: 70, boardingDate: '2024-03-01', location: '엔진룸 (사고지점)', pastHistory: '2021년 고혈압 진단, 현재 암로디핀 복용 중', dob: '1971-08-05', gender: '남', lastMed: '암로디핀 5mg, 리피토 10mg', note: '기관실 제2엔진 추락 사고 발생 (늑골 골절 의심)' },
